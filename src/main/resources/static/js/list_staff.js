 ...
 $(function() {
    ...
    $("i[class*=icon-zx-xin]").click(function(){
 	...
 	$(".commonContent").bind("scroll",function(){
 		if($(".staffList li").length<1 || $(".commonContent").find('#load').length>0){
 			return;
 		}
 		if( $(this).scrollTop()>$(".staffList").height()-$(this).height()-10){
